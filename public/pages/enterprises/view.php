...
if (!isset($_GET['id'])) {
    header('Location: ' . BASE_URL . '/public/pages/enterprises/list.php');
    exit();
}
...
$stmt = $db->prepare("
    SELECT u.*, eu.role as enterprise_role
    FROM users u
...
<div class="dashboard-container">
    <div class="dashboard-content">
        <div class="dashboard-header">
            <h1><?php echo htmlspecialchars($enterprise['name']); ?></h1>
            <div class="header-actions">
                <a href="edit.php?id=<?php echo $enterprise_id; ?>" class="btn btn-primary">
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        <label>Name</label>
                        <span><?php echo htmlspecialchars($enterprise['name']); ?></span>
                    </div>
                    <div class="info-item">
                        <label>Email</label>
                        <span><?php echo htmlspecialchars($enterprise['email']); ?></span>
                    </div>
                    <div class="info-item">
                        <label>Phone</label>
                        <span><?php echo htmlspecialchars($enterprise['phone']); ?></span>
                    </div>
                    <div class="info-item">
                        <label>NIF</label>
                        <span><?php echo htmlspecialchars($enterprise['nif']); ?></span>
                    </div>
                    <div class="info-item">
                        <label>Status</label>
                        <span class="badge <?php echo $enterprise['status'] == 'active' ? 'badge-success' : 'badge-danger'; ?>">
                            <?php echo ucfirst($enterprise['status']); ?>
                        </span>
                    </div>
                    <div class="info-item">
                        <label>Created At</label>
                        <span><?php echo date('d/m/Y H:i', strtotime($enterprise['created_at'])); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="info-grid">
                    <div class="info-item full-width">
                        <label>Address</label>
                        <span><?php echo htmlspecialchars($enterprise['address']); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="info-grid">
                    <div class="info-item full-width">
                        <span><?php echo nl2br(htmlspecialchars($enterprise['description'])); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <span><?php echo $enterprise['total_users']; ?></span>
                    </div>
                    <div class="info-item">
                        <label>Total Projects</label>
                        <span><?php echo $enterprise['total_projects']; ?></span>
                    </div>
                    <div class="info-item">
                        <label>Total Budgets</label>
                        <span><?php echo $enterprise['total_budgets']; ?></span>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ucfirst($user['enterprise_role']); ?></td>
                                        <td>
